...
\author{\IEEEauthorblockN{Book Sadprasid}
...
Gathered audio files were later transformed to adhere to similar audio parameters. Stereo sound was split into different mono channels, down-sampled from 44.1kHz to 15kHz. Frequency change was motivated by the fact that useful hit sound information is mostly located in lower parts of frequency range and removing unimportant parts of data can simplify computation. All files were converted to .wav format for the purposes of unification and further exploitation of Tensorflow audio library capabilities that easily integrate with .wav audio format.
